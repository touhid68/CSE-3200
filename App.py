...
def open_file(initialdir='/'):
    ...
    dialog_var.set("Browse Model But Not Yet Load The Model")
    h5_var.set(file_path)

    return file_path

def load_weights():
    dialog_var.set("Loading Model.......")
...
test_image = image.load_img('dataset2/test_set/Rice__Brownspot/brownspot_orig_003.jpg', target_size=(64, 64))
...
btn_h5_confirm = Button(top_frame, text='Load Model',  command = load_weights , bg="black", fg="white" )
...
test_result_var.set("Result shown here")
...
dialog_var.set("Welcome to the AI wolrd!")
